    ...
    public void consultarPublicaciones(PostAdapter adapter) {
        ...
        call.enqueue(new Callback<PostResponse>() {
            ...
            public void onResponse(Call<PostResponse> call, Response<PostResponse> response) {
                ...
                try {
                    ...
                    if (postResponse != null) {
                        ...
                        Toast.makeText(MainActivity3.this, "Error: Received empty response.", Toast.LENGTH_SHORT).show();
                    }
                } catch (JsonSyntaxException e) {
                    System.out.println("JsonSyntaxException: " + e.getMessage());
                    Toast.makeText(MainActivity3.this, "JSON Parsing Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(Call<PostResponse> call, Throwable t) {
                ...
                Toast.makeText(MainActivity3.this, "Network error while fetching posts: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void crearPost(View view) {
        ...
        call.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(MainActivity3.this, "Publicado", Toast.LENGTH_SHORT).show();
                } else {

                    Toast.makeText(MainActivity3.this, "Error al Publicar", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<Object> call, Throwable t) {
                ...
                Toast.makeText(MainActivity3.this, "Error de conexión: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
